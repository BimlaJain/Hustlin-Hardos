...
const Roadmap = () => {
    ...
    return (
        <div className="pb-[78px] ">
            ...
            <div className="relative flex flex-col items-center container max-w-[1172px] mx-auto px-4 xl:border-x-2 lg:pt-[99px] pt-10 xl:pb-[220px] lg:pb-[120px] pb-[150px]">
                <div className="absolute top-0 xl:h-[1700px] lg:h-[1900px] md:h-[1350px] h-[1440px] max-md:right-[7%]">
                ...
                {ROADMAP_DATA.map((item, index) => (
                    <div key={index} className={` flex w-full items-start ${index % 2 === 0 ? 'justify-end' : 'justify-start'}`}>
                        <div className={`relative md:w-1/2 w-full  rounded-lg hover:shadow-md ${index % 2 === 0 ? 'justify-end lg:pl-[75px] md:pl-9' : 'md:justify-start justify-end lg:pr-[75px] pr-5 lg:pl-9 '} :flex-row flex-col`}>
